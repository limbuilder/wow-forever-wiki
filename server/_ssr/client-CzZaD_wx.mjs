...
import { et as require_react } from "../_libs/@base-ui/react+[...].mjs";
import { c as env, i as BetterAuthError } from "./env-impl-DfE6feVB.mjs";
import { t as capitalizeFirstLetter } from "./string-BnK4G_5Y.mjs";
import processModule from "node:process";
//#region node_modules/.nitro/vite/services/ssr/assets/client-CzZaD_wx.js
...
var baseURL = typeof window !== "undefined" ? window.location.origin : "https://wowforeverwiki.org";
var authClient = createAuthClient({ baseURL });
var { signIn, signUp, signOut, useSession, requestPasswordReset, resetPassword } = authClient;
function getAuthClient(configs) {
	return createAuthClient({
		baseURL,
		plugins: configs.google_client_id && configs.google_one_tap_enabled === "true" ? [oneTapClient({
...
//#endregion
export { signUp as _, defu as a, getHost as c, isDynamicBaseURLConfig as d, requestPasswordReset as f, signOut as g, signIn as h, createDefu as i, getOrigin as l, resolveBaseURL as m, authClient as n, getAuthClient as o, resetPassword as p, betterFetch as r, getBaseURL as s, PACKAGE_VERSION as t, getProtocol as u, useSession as v, wildcardMatch as y };
