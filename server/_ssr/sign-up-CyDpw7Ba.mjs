...
import { $a as common_sign_or, Aa as common_sign_already_have_account, Ba as common_sign_github_sign_in, Fa as common_sign_email_placeholder, Ga as common_sign_invite_code_title, Ha as common_sign_invite_code_invalid, Ia as common_sign_email_title, Ka as common_sign_name_placeholder, Na as common_sign_confirm_password_placeholder, Pa as common_sign_confirm_password_title, Qa as common_sign_no_methods_title, Ua as common_sign_invite_code_placeholder, Va as common_sign_google_sign_in, Wa as common_sign_invite_code_required, Za as common_sign_no_methods_description, eo as common_sign_password_mismatch, io as common_sign_password_title, qa as common_sign_name_title, to as common_sign_password_placeholder, xo as common_sign_sign_up_title, yo as common_sign_sign_in_title } from "./messages-DKBWZPg0.mjs";
...
import { _ as signUp, h as signIn, n as authClient, v as useSession } from "./client-CzZaD_wx.mjs";
...
import { a as FieldSeparator, n as FieldDescription, r as FieldGroup, t as Field } from "./field-BZh9EFVs.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/sign-up-CyDpw7Ba.js
	...
	const form = useForm({
		...
		onSubmit: async ({ value }) => {
			...
			try {
				...
				if (inviteCodeRequired && trimmedInvite) try {
					...
					emailEnabled && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(form.Field, {
							...
							children: (field) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextField, {
								...
								type: "text",
								required: true,
								placeholder: common_sign_name_placeholder()
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(form.Field, {
							name: "email",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(form.Field, {
							...
							children: (field) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextField, {
								...
								type: "password",
								required: true,
								placeholder: common_sign_confirm_password_placeholder()
							})
						}),
						inviteCodeRequired && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(form.Field, {
							name: "inviteCode",
							children: (field) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextField, {
								field,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Field, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(form.Subscribe, {
							...
							children: (isSubmitting) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button$1, {
								...
								children: isSubmitting ? "..." : common_sign_sign_up_title()
							})
